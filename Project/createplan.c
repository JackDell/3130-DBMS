					 ...
					 Plan *inner_plan)
{
	...
	hash_plan_outter = make_hash(outer_plan);

	join_plan = make_hashjoin(tlist, joinclauses, otherclauses, hashclauses, (Plan *) hash_plan_outter, (Plan *) hash_plan_inner, best_path->jpath.jointype);
